<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="Trash.aspx.cs" Inherits="Jet_Mail.Trash" %>
        ...
        <div class="col-lg-12 ">
            <div class="panel-default">
                ...
                <div class="inbox-page">
                    ...
                    <asp:DataList ID="DataList1" runat="server" CssClass="table" OnDeleteCommand="DataList1_DeleteCommand">
                        <ItemTemplate>
