<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="Inbox.aspx.cs" Inherits="Jet_Mail.HomePage1" %>
        ...
        <div class="col-lg-12 " style="left: 0px; top: -27px">
            <div class="panel-default">
                ...
                <div class="inbox-page">
                    ...
                    <asp:DataList ID="DataList2" runat="server" CssClass="table" OnDeleteCommand="DataList2_DeleteCommand" OnEditCommand="DataList2_EditCommand" OnUpdateCommand="DataList2_UpdateCommand" OnCancelCommand="DataList2_CancelCommand" OnItemCommand="DataList2_ItemCommand">
                        <ItemTemplate>
                                ...
                                <div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="mail">
                                        ...
                                        <asp:Label ID="Label6" runat="server" Text='<%# Bind("StarByReceiver")%>' Visible="false"></asp:Label>
                                    </div>


                                        <asp:LinkButton ID="LinkButton5" runat="server"  CommandName="details">
                                    ...
                                    <div class="mail-right dots_drop">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu float-right">
                                                ...
                                                <li>
                                                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Delete">  <i class="fa fa-trash-o mail-icon"></i>Delete</asp:LinkButton>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="mail-body">
                                            <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" ReadOnly="true" Text='<%# Bind("Message")%>' BorderStyle="None" Height="500px" Width="100%" Style="color:black" ></asp:TextBox>
