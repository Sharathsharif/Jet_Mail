<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="Starred_mail.aspx.cs" Inherits="Jet_Mail.Starred_mail" %>
        ...
        <div class="col-lg-12 " style="left: 0px; top: -27px">
            <div class="panel-default">
                ...
                <div class="inbox-page">
                    ...
                    <h4>Received Mail List</h4>

                    <asp:DataList ID="DataList2" runat="server" CssClass="table" OnDeleteCommand="DataList2_DeleteCommand" OnUpdateCommand="DataList2_UpdateCommand">
                        <ItemTemplate>
                            <div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="mail ">
                                                ...
                                                <asp:LinkButton ID="LinkButton3" runat="server" visible="false" CommandName="edit">  
                                                    ...
                                                    <asp:LinkButton ID="LinkButton4" runat="server" visible="true" CommandName="update">
                    ...
                    <asp:DataList ID="DataList1" runat="server" CssClass="table" OnDeleteCommand="DataList1_DeleteCommand" OnUpdateCommand="DataList1_UpdateCommand">
                        <ItemTemplate>
                            <div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="mail ">
                                    <input type="checkbox" class="checkbox">
